...
class ExcelProcessor {
    ...
    fun processFile(inputStream: InputStream): ProcessResult {
        ...
        for (sheetIndex in 0 until workbook.numberOfSheets) {
            ...
            // Find header row and column indices for this sheet
            ...
            // Extract shipment info from first sheet only
            if (sheetIndex == 0 && headerRowIndex > 0) {
